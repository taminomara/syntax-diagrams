...
UNICODE_VERSION = ...
def graphemes(string): # -> GraphemeIterator:
    """
...
def grapheme_lengths(string): # -> Generator[int, None, None]:
    """
    Returns an iterator of number of code points in each grapheme of the string.
    """
    ...

def slice(string, start=..., end=...): # -> Literal['']:
    """
...
def contains(string, substring): # -> bool:
    """
...
def endswith(string, suffix): # -> bool:
    """
...
def safe_split_index(string, max_len): # -> int:
    """
